...
所以在添加交易币种后，系统会根据输入的币种名称，访问okx服务器，获取合约面值大小。

BTC-USDT-SWAP的合约面值是0.01

ETH-USDT-SWAP的合约面值是0.1

SOL-USDT-SWAP的合约面值是1
...
-减少线程数，原来三个websocket要用到三个心跳线程，应该减小到一个，让该心跳线程每次心跳能够维护三个websocket的连接
